...
本文档说明如何注册 Replicate 账号并获取 API Token。
...
5. Token 创建后只显示一次，立即复制并保存

### Token 格式说明

- Replicate API Token 通常以 `r8_` 开头
- 长度约为 40-50 个字符
- 格式示例：`r8_xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx`
...
**A**: Token 默认不会过期，除非你手动删除。建议定期检查 Token 的有效性。
